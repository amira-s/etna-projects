...
function usage()
{
	echo "\033[33mUsage: ./etna_movies.php add_student login.\n";
	...
	echo "Usage: ./etna_movies.php show_renting_students.\n";
	echo "Usage: ./etna_movies.php rent_movie login imdb_code.\n";
	echo "Usage: ./etna_movies.php return_movie login imdb_code.\033[0m\n";
}
